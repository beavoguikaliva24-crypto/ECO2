# Generated by Django 6.0.2 on 2026-02-17 19:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='photoeleves/', verbose_name='Photo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annee_aff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ecorys.tableannee', verbose_name='Année scolaire')),
                ('classe_aff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ecorys.tableclasse', verbose_name='Classe')),
                ('eleve_aff', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecorys.tableeleve', verbose_name='Elève')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annee_fs', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ecorys.tableannee', verbose_name='Année scolaire')),
                ('classe_fs', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecorys.tableclasse', verbose_name='Classe')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='niveau_classe',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ecorys.tableniveau', verbose_name='Niveau'),
        ),
        migrations.AddField(
            model_name='tableclasse',
            name='option_classe',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ecorys.tableoption', verbose_name='Option'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affectation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ecorys.tableaffectation', verbose_name='Effectation')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permission', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ecorys.tablepermission', verbose_name='Permission')),
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ecorys.tablerole', verbose_name='Rôle')),
            ],
            options={
